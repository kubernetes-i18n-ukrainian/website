...
-->
Те, як Kubernetes обмінюється даними з вашим кластером, визначається різними процесами у площині управління Kubernetes, такими як Kubernetes master і kubelet. Площина управління веде облік усіх об’єктів Kubernetes, що наявні у системі, і безперервно запускає контрольні цикли для управління станом цих об’єктів. У будь-який час контрольні цикли, запущені площиною управління, реагуватимуть на зміни у кластері і намагатимуться привести поточний стан об’єктів до бажаного, що заданий у конфігурації.
